...
images = uf.read_images('./curule_dataset/')
uf.progressbar("Reading images from curule_dataset", 0)
...
concat = uf.display_matches_on_images(img0, img1, sift_matched_pairs, [0,0,255], "SIFT_on_curule.png")
...
cv2.imwrite("epipolar_lines_on_unrectified_images_curule_dataset.png", unrectified_output)
...
cv2.imwrite("epipolar_lines_on_rectified_images_curule_dataset.png", rectified_output)
...
cv2.imwrite("Disparity_in_greyscale_on_curule_dataset.png", dispairity_computed_img)
cv2.imwrite("Disparity_in_heatmap_on_curule_dataset.png", heatmap_img)
...
cv2.imwrite("Depth_in_greyscale_on_curule_dataset.png", depth_img)
cv2.imwrite("Depth_in_heatmap_on_curule_dataset.png", depth_img_heatmap)
